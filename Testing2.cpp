...
private:
    ...
    int rows_, columns_, zombie_counts_;
    vector<char> items;
...
// ---------- Game board functions ---------- //
    ...
    void game_characters()
    {
        ...
        {
            int row = rand() % (rows_);
            int column = rand() % (columns_);
            board_[row][column] = 'Z';
            
            cout.width(2);
            cout << i + 1 << ". (" << row + 1 << ", " << column + 1 << ")" << endl;
        }
    }
...
// ---------- Command functions ---------- //
    ...
    void find_alien(int& alien_row, int& alien_column)
    {
        ...
        for (int i = 0; i < rows_; ++i)
        {
            for (int j = 0; j < columns_; ++j)
            {
                if (board_[i][j] == 'A')
                {
                    alien_row = i; // columns
                    alien_column = j; // rows
                    cout << "Found alien at (" << alien_row + 1 << ", " << alien_column + 1 << ")" << endl;
                }
            }
        }
    }

    void up(int& alien_row, int& alien_column)
    {
        find_alien(alien_row, alien_column);

        // Replace next with 'A' and previous with '.'
        int rock_flag = 0;
        for (int i = 1, j = 0; i <= alien_row; ++i, ++j)
        {
            // TESTING
            cout << endl;
            cout << "On top of alien is (" << board_[alien_row - i][alien_column] << ")" << endl;

            if (board_[alien_row - i][alien_column] == 'r') // ------------------------------ Alien finds rock (JUWEI)
            {
                string something;

                int random_num = rand() % 2;
                board_[alien_row - i][alien_column] = items[random_num];
            ...
            else if (board_[alien_row - i][alien_column] == 'p') // ------------------------- Alien finds pods (JIAHEN)
            {
                ...
                board_[alien_row - i][alien_column] = 'A'; // --- Next
                board_[alien_row - j][alien_column] = '.'; // --- Previous
            }
            else if (board_[alien_row - i][alien_column] == 'h') // ------------------------- Alien finds health pack (DONE)
            {
            ...
            else if (board_[alien_row - i][alien_column] == ' ')
            {
                board_[alien_row - i][alien_column] = 'A'; // --- Next
                board_[alien_row - j][alien_column] = '.'; // --- Previous
            }
            else if (board_[alien_row - i][alien_column] == 'Z') // ------------------------- Alien finds zombie
            {
            ...
            {
                cout << "Alien finds an arrow, but still yet to be implemented." << endl;
                board_[alien_row + i][alien_column] = 'A'; // --- Next
                board_[alien_row + j][alien_column] = '.'; // --- Previous
            }
            pause();
        ...
        if (rock_flag != 1) // If did not hit rock
        {
            cout << endl;
    ...
    void down(int& alien_row, int& alien_column)
    {
        // Replace next with 'A' and previous with '.'
        int rock_flag = 0;
        for (int i = 1, j = 0; i <= alien_row; ++i, ++j)
        {
            // TESTING
            cout << endl;
            cout << "Below alien is (" << board_[alien_row + i][alien_column] << ")" << endl;
    ...
    void left(int& alien_row, int& alien_column)
    {
        // Replace next with 'A' and previous with '.'
        int rock_flag = 0;
        for (int i = 1, j = 0; i <= alien_column; ++i, ++j)
        {
            // TESTING
            cout << endl;
            cout << "On the left of alien is (" << board_[alien_row][alien_column - i] << ")" << endl;

            if (board_[alien_row][alien_column - i] == 'r') // ------------------------------ Alien finds rock (JUWEI)
            {
                string something;

                int random_num = rand() % 2;
                board_[alien_row][alien_column - i] = items[random_num];
            ...
            else if (board_[alien_row][alien_column - i] == 'p') // ------------------------- Alien finds pods (JIAHEN)
            {
                cout << "Alien finds a pod." << endl;
                cout << "Zombie ? received a damage of 10" << endl;
                // Find the nearest zombie
                ...
                // if z < range == attack the nearest zombie
                // The zombie's health - 10
                board_[alien_row][alien_column - i] = 'A'; // --- Next
                board_[alien_row][alien_column - j] = '.'; // --- Previous
            }
            else if (board_[alien_row][alien_column - i] == 'h') // ------------------------- Alien finds health pack (DONE)
            {
                cout << "Alien finds a health pack." << endl;
                cout << "Alien's life is increased by 20." << endl;
                alien_health = alien_health + 20;
            ...
            else if (board_[alien_row][alien_column - i] == ' ')
            {
                board_[alien_row][alien_column - i] = 'A'; // --- Next
                board_[alien_row][alien_column - j] = '.'; // --- Previous
            }
            else if (board_[alien_row][alien_column - i] == 'Z') // ------------------------- Alien finds zombie
            {
                cout << "Alien finds zombie, but still yet to be implemented." << endl;
                board_[alien_row][alien_column - i] = 'A'; // --- Next
                board_[alien_row][alien_column - j] = '.'; // --- Previous
    ...
    void right(int& alien_row, int& alien_column)
    {
        // Replace next with 'A' and previous with '.'
        int rock_flag = 0;
        for (int i = 1, j = 0; i <= alien_column; ++i, ++j)
        {
            // TESTING
            cout << endl;
            cout << "On the right of alien is (" << board_[alien_row][alien_column + i] << ")" << endl;
    ...
    void commands()
    {
        ...
        {
            int alien_row, alien_column; // alien's (x, y) in vector
            find_alien(alien_row, alien_column);
            up(alien_row, alien_column);
        }
        else if (command == "down")
        {
            int alien_row, alien_column; // alien's (x, y) in vector
            find_alien(alien_row, alien_column);
            down(alien_row, alien_column);
        }
        else if (command == "left")
        {
            int alien_row, alien_column; // alien's (x, y) in vector
            find_alien(alien_row, alien_column);
            left(alien_row, alien_column);
        }
        else if (command == "right")
        {
            int alien_row, alien_column; // alien's (x, y) in vector
            find_alien(alien_row, alien_column);
            right(alien_row, alien_column);
        }
